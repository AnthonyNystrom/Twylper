...
$query = "SELECT discussions.* FROM discussions LEFT JOIN topics ON topics.string = discussions.string LEFT JOIN users ON users.id = discussions.user_id WHERE users.id=" . $userId;
